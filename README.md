...
- Java JDK 11+
- Android SDK
- Android Emulator via Android Studio / Physical Device
- Appium Server
- Node.js
- Gradle
...
3. Clone source repository: git clone https://github.com/pauluskurnianto62/ANMP_W8.git
4. Clone this repository: git clone https://github.com/pauluskurnianto62/appium_automation.git
5. Navigate to project directory: cd appium-automation
